...
<body>
<div class="container">
  <h2>Control DHCP (dnsmasq)</h2>

  <div class="menu">
    <a href="/cgi-bin/dhcp.cgi?comand=estat" target="body">
      <div class="button">Estat del Servei</div>
    </a>

    <a href="/cgi-bin/dhcp.cgi?comand=iniciar" target="body">
